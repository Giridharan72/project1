...
// //           from,
// //           to,
// //           runsOnDays: { [Op.contains]: [new Date(datesAvailable).getDay()] }
// //         }
// //       });
// //     } else {
// //       buses = await Bus.findAll();
...
//     facilities,
//     fare,
//     reviews, // This was missing in the original function
//     datesAvailable // This was missing in the original function
//   } = req.body;
...
//     res.status(500).json({ error: 'Error fetching available bus records' });
//   }
// };
